export default {
  ...
  Subtitle: '世事难料，诸位慢行',
  // 网站描述
  Description: 'SPAWNSBlog 专注于配电自动化与相关技术的理论分享，涵盖配电网一二次电气设备的系统运行原理以及维保方法等，并涉及IEC104协议、IEC101协议、GOOSE协议、Modbus协议、Linux、Docker等领域。',
  // 网站作者
  Author: '𝑺𝑷𝑨𝑾𝑵𝑺',
  // 作者头像
  ...
  TypeWriteList: [
    ...
    '可当你开始有了自己的思考方式',
    '你会发现这些认知的偏差和局限性，你所坚信的东西也许并不那么坚定',
  ...
  Navs: [
    ...
    { text: '数据库', link: 'https://www.spawns.cc/', icon: 'WebSite_hot' },
